...
class MAB(object):
    ...
    def __init__(self, configuration):
        ...
        if isinstance(configuration, dict):
            ...
            # SlyJabiru
            nbArmsPerAgents = np.array(configuration['nbArmsPerAgents'])
            self.nbArmsPerAgents = nbArmsPerAgents
            print(" - with 'nbArmsPerAgents' =", self.nbArmsPerAgents)  # DEBUG
        ...
        self.maxArm = configuration['maxArm'] if 'maxArm' in configuration else np.max(self.means)  #: Max mean of arms
        print(" - with 'maxArm' =", self.maxArm)  # DEBUG
        self.minArm = configuration['minArm'] if 'minArm' in configuration else np.min(self.means)  #: Min mean of arms
        ...
        # SlyJabiru
        self.ArmTypeString = str(self.arms[0])
